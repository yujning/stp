...
int main()
{
  ...
  MatrixXi mat3 = stp::expr_normalize( expr3, input_names, true );
  std::cout << "The normal matrix for expression " << expr3 << " is " << std::endl;
  std::cout << mat3 << std::endl;
  std::cout << "The binary truth table is: " << stp::to_binary( mat3 ) << std::endl;
